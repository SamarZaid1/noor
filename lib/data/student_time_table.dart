...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['timetable'] != null) {
      timetable = <Null>[];
      //json['timetable'].forEach((v) { timetable!.add(new Null.fromJson(v)); });
    }
  }
...
class FamilyConIds {
  ...
  FamilyConIds.fromJson(Map<String, dynamic> json) {
    ...
    if (json['family_contact_id'] != null) {
     ...
     /* json['family_contact_id'].forEach((v) {
        familyContactId!.add(new List.fromJson(v)); });*/
    }
