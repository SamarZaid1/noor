...
class Exam {
  ...
  Exam({this.id, this.displayName, this.addtionalExamCode, this.standardId, this.dept, this.subjectId, this.examDate, this.maximumMarks, this.minimumMarks, this.weightage, this.academicYear, this.examAspects, this.totalMax});
  ...
  Exam.fromJson(Map<String, dynamic> json) {
    ...
    standardId = json['standard_id'] != null ? new UserId.fromJson(json['standard_id']) : null;
    dept = json['dept'] != null ? new UserId.fromJson(json['dept']) : null;
    subjectId = json['subject_id'] != null ? new UserId.fromJson(json['subject_id']) : null;
    examDate = json['exam_date'];
    maximumMarks = json['maximum_marks'];
    minimumMarks = json['minimum_marks'];
    weightage = json['weightage'];
    academicYear = json['academic_year'] != null ? new UserId.fromJson(json['academic_year']) : null;
...
class ExamAspects {
  ...
  ExamAspects({this.id, this.name, this.examType, this.examDate, this.maximumMarks, this.minimumMarks, this.isStandalone, this.additionInv, this.sLastUpdate, this.displayName, this.createUid, this.createDate, this.writeUid, this.writeDate});
  ...
  ExamAspects.fromJson(Map<String, dynamic> json) {
    ...
    if (json['addition_inv'] != null) {
      additionInv = <List>[];
     // json['addition_inv'].forEach((v) { additionInv!.add(new List.fromJson(v)); });
    }
...
AdditionInv.fromJson(Map<String, dynamic> json) {
}
...
class Data1 {
  ...
  Data1({this.id, this.displayName, this.familyConIds, this.userId, this.pid, this.regCode, this.studentCode, this.contactPhone, this.contactMobile, this.rollNo, this.photo, this.year, this.admissionDate, this.middle, this.last, this.gender, this.dateOfBirth, this.age, this.maritualStatus, this.referenceIds, this.previousSchoolIds, this.doctor, this.designation, this.doctorPhone, this.bloodGroup, this.height, this.weight, this.eye, this.ear, this.noseThroat, this.respiratory, this.cardiovascular, this.neurological, this.muskoskeletal, this.dermatological, this.bloodPressure, this.remark, this.schoolId, this.state, this.historyIds, this.certificateIds, this.studentDisciplineLine, this.document, this.description, this.awardList, this.acadamicYear, this.divisionId, this.sectionId, this.standardId, this.terminateReason, this.active, this.teachrUserGrp, this.idNationalType, this.number, this.record, this.paperRecord, this.releasePlace, this.releaseDate, this.documentNumber, this.graduationPlace, this.mangerialEducation, this.educationBranch, this.graduationYear, this.finalGrade, this.iraqiNationalityPlace, this.nationalityNo, this.nationalityDate, this.previousAddress, this.currentAddress, this.nearestPoint, this.eduType, this.originalDoc, this.medicalExamination, this.pic, this.eduCust, this.unified, this.card, this.nation, this.residenceCard, this.tamoin, this.privateChannel, this.nocosatNotes, this.title, this.studentResult, this.failYears, this.managerOrder, this.acceptanceChannel, this.managerOrder1, this.yearAccept, this.acceptanceStudent, this.statusStudent, this.eduYearOrder, this.empStudent, this.birthPlace, this.fatherPhone, this.fatherJob, this.motherPhone, this.motherJob, this.examResultsIds, this.exam});
...
class Exam1 {
  ...
  Exam1({this.id, this.displayName, this.addtionalExamCode, this.standardId, this.dept, this.subjectId, this.examDate, this.maximumMarks, this.minimumMarks, this.weightage, this.academicYear, this.examAspects, this.totalMax});

  Exam1.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    displayName = json['display_name'];
    addtionalExamCode = json['addtional_exam_code'];
    standardId = json['standard_id'] != null ? new UserId.fromJson(json['standard_id']) : null;
